...
void house1(float x, float y, int m = 1) //add color parameters like roof, wall, windows etc and use those in functions(polygon,quad). For example see ""tree()""
{
    //green polygon
    polygon({{x + m * 0, y + 0}, {x + m * 40.06, y + -0.01}, {x + m * 40.14, y + 26.27}, {x + m * 19.84, y + 48.1}, {x + m * -0.04, y + 26.06}}, {1, 1, 1});

    //wall(side)
    quad({{x + m * 40.06, y + -0.01}, {x + m * 87.76, y + -0.01}, {x + m * 87.55, y + 26.14}, {x + m * 40.14, y + 26.27}}, {100, 100, 100});

    //roof
    quad({{x + m * 19.84, y + 48.1}, {x + m * 40.14, y + 26.27}, {x + m * 87.55, y + 26.14}, {x + m * 67.91, y + 47.99}}, {150, 200, 100});

    //windows
    quad({{x + m * 6.64, y + 7.08}, {x + m * 10.82, y + 7.08}, {x + m * 10.82, y + 19.13}, {x + m * 6.64, y + 19.13}, {x + m * 17.84, y + 7.07}, {x + m * 22.02, y + 7.07}, {x + m * 22.02, y + 19.12}, {x + m * 17.84, y + 19.12}, {x + m * 29.32, y + 7.11}, {x + m * 33.5, y + 7.11}, {x + m * 33.5, y + 19.16}, {x + m * 29.32, y + 19.16}, {x + m * 46.77, y + 6.89}, {x + m * 50.95, y + 6.89}, {x + m * 50.95, y + 18.94}, {x + m * 46.77, y + 18.94}, {x + m * 61.92, y + 6.71}, {x + m * 66.11, y + 6.71}, {x + m * 66.11, y + 18.76}, {x + m * 61.92, y + 18.76}, {x + m * 76.91, y + 6.89}, {x + m * 81.09, y + 6.89}, {x + m * 81.09, y + 18.94}, {x + m * 76.91, y + 18.94}}, {250, 200, 60});
}
void house2(float x, float y, int m = 1)
{
    polygon({{x + m * 0, y + 0}, {x + m * 40.07, y + 0}, {x + m * 40.14, y + 26.27}, {x + m * 19.84, y + 48.1}, {x + m * -0.04, y + 26.06}}, {250, 200, 60});
    ...
    glEnd();*/
    //
    quad({{x + m * 40.07, y + 0}, {x + m * 141.26, y + 0}, {x + m * 141.06, y + 26.27}, {x + m * 40.14, y + 26.27}}, {29, 70, 30});
    /*glColor3ub(29,70,30);
    glBegin(GL_QUADS);
    glVertex2f(x+m*40.07,y+ 0);
    ...
    //door
    quad({{x + m * 19.84, y + 48.1}, {x + m * 40.14, y + 26.27}, {x + m * 141.06, y + 26.27}, {x + m * 121.52, y + 48.26}}, {25, 20, 70});
    /*glColor3ub(25,20,70);
    glBegin(GL_QUADS);
    glVertex2f(x+m*19.84,y+ 48.1);
    glVertex2f(x+m*40.14,y+ 26.27);
    ...
    //window
    quad({{x + m * 6.65, y + 7.08}, {x + m * 10.83, y + 7.08}, {x + m * 10.83, y + 19.13}, {x + m * 6.65, y + 19.13}, {x + m * 17.82, y + 7.15}, {x + m * 22, y + 7.15}, {x + m * 22, y + 19.2}, {x + m * 17.82, y + 19.2}, {x + m * 29.36, y + 6.98}, {x + m * 33.54, y + 6.98}, {x + m * 33.54, y + 19.03}, {x + m * 29.36, y + 19.03}, {x + m * 46.23, y + 14.96}, {x + m * 50.83, y + 14.96}, {x + m * 50.83, y + 19.01}, {x + m * 46.23, y + 19.01}, {x + m * 60.35, y + 15.09}, {x + m * 64.94, y + 15.09}, {x + m * 64.94, y + 19.13}, {x + m * 60.35, y + 19.13}, {x + m * 74.39, y + 14.88}, {x + m * 78.99, y + 14.88}, {x + m * 78.99, y + 18.92}, {x + m * 74.39, y + 18.92}, {x + m * 88.43, y + 14.88}, {x + m * 93.03, y + 14.88}, {x + m * 93.03, y + 18.92}, {x + m * 88.43, y + 18.92}, {x + m * 102.53, y + 15.09}, {x + m * 107.12, y + 15.09}, {x + m * 107.12, y + 19.13}, {x + m * 102.53, y + 19.13}, {x + m * 116.46, y + 14.91}, {x + m * 121.06, y + 14.91}, {x + m * 121.06, y + 18.96}, {x + m * 116.46, y + 18.96}, {x + m * 130.73, y + 14.91}, {x + m * 135.33, y + 14.91}, {x + m * 135.33, y + 18.95}, {x + m * 130.73, y + 18.95}}, {255, 100, 60});
...
{
    //polygon
    polygon({{x + m * 0, y + 0}, {x + m * 40.34, y + 0}, {x + m * 40.34, y + 51.78}, {x + m * 19.91, y + 74.55}, {x + m * 0.26, y + 52.67}}, {55, 140, 30});
    ...
    //side wall
    quad({{x + m * 40.34, y + 0}, {x + m * 101.25, y + 0}, {x + m * 101.22, y + 52.29}, {x + m * 40.34, y + 51.78}}, {124, 170, 120});
    ...
    quad({{x + m * 19.91, y + 74.55}, {x + m * 40.34, y + 51.78}, {x + m * 101.22, y + 52.29}, {x + m * 81.25, y + 74.62}}, {25, 0, 230});
    /*glColor3ub(25, 0, 230);
    glVertex2f(x + m * 19.91, y + 74.55);
    glVertex2f(x + m * 40.34, y + 51.78);
    glVertex2f(x + m * 101.22, y + 52.29);
    ...
    //windows
    quad({{x + m * 5.71, y + 33.74}, {x + m * 15.4, y + 33.74}, {x + m * 15.4, y + 45.7}, {x + m * 5.71, y + 45.7}, {x + m * 24.99, y + 33.5}, {x + m * 34.68, y + 33.5}, {x + m * 34.68, y + 45.46}, {x + m * 24.99, y + 45.46}, {x + m * 5.78, y + 10.08}, {x + m * 15.47, y + 10.08}, {x + m * 15.47, y + 22.04}, {x + m * 5.78, y + 22.04}, {x + m * 24.81, y + 10.08}, {x + m * 34.5, y + 10.08}, {x + m * 34.5, y + 22.04}, {x + m * 24.81, y + 22.04}}, {155, 240, 90});
    ...
    //door
    quad({{x + m * 65.8, y + 0.08}, {x + m * 75.48, y + 0.11}, {x + m * 75.48, y + 21.85}, {x + m * 65.8, y + 21.85}}, {65, 130, 70});
...
void tree(float Tx, float Ty, float s = 1, Color treeleft, Color treeRight, Color treeBase)
{
    //left
...
{
    polygon({{Tx + m * 133.68, Ty + 209.63}, {Tx + m * 259.04, Ty + 48.56}, {Tx + m * 338.81, Ty + 90.11}, {Tx + m * 244.79, Ty + 207.92}}, {240, 250, 10});
    polygon({{Tx + m * 106.9, Ty + 171.5}, {Tx + m * 259.04, Ty + 48.56}, {Tx + m * 133.68, Ty + 209.63}}, {150, 30, 75});
    polygon({{Tx + m * 106.9, Ty + 171.5}, {Tx + m * 35.39, Ty + 69.68}, {Tx + m * 48.76, Ty + 74.43}, {Tx + m * 112.63, Ty + 166.87}}, {30, 149, 140});
    polygon({{Tx + m * 35.39, Ty + 69.68}, {Tx + m * 46.37, Ty + 65.9}, {Tx + m * 61.53, Ty + 28.05}, {Tx + m * 65.69, Ty + 28.29}, {Tx + m * 48.76, Ty + 74.43}}, {89, 69, 99});
    polygon({{Tx + m * 65.69, Ty + 28.29}, {Tx + m * 235.44, Ty + 15.1}, {Tx + m * 243.29, Ty + 61.29}, {Tx + m * 112.72, Ty + 167}, {Tx + m * 48.76, Ty + 74.43}}, {200, 100, 10});
    polygon({{Tx + m * 129.34, Ty + 24.23}, {Tx + m * 133.46, Ty + 141.46}, {Tx + m * 135.84, Ty + 139.65}, {Tx + m * 137.52, Ty + 23.71}}, {47, 177, 37});
    polygon({{Tx + m * 243.29, Ty + 61.29}, {Tx + m * 235.44, Ty + 15.1}, {Tx + m * 314.05, Ty + 53.57}, {Tx + m * 317.81, Ty + 79.15}, {Tx + m * 259.04, Ty + 48.56}}, {34, 156, 209});
    triangle({{Tx + m * 361.32, Ty + 79.37}, {Tx + m * 368.56, Ty + 79.37}, {Tx + m * 365.2, Ty + 57.39}, {Tx + m * 292.93, Ty + 26.69}, {Tx + m * 300.17, Ty + 26.69}, {Tx + m * 296.86, Ty + 2.61}, {Tx + m * 2.67, Ty + 53.7}, {Tx + m * 9.91, Ty + 53.7}, {Tx + m * 6.59, Ty + 29.62}}, {120, 144, 33});
    quad({{Tx + m * 36.47, Ty + 69.31}, {Tx + m * 2.54, Ty + 44.22}, {Tx + m * 3.54, Ty + 42.45}, {Tx + m * 37.5, Ty + 68.95}, {Tx + m * 260.36, Ty + 49.25}, {Tx + m * 300.9, Ty + 18.44}, {Tx + m * 301.29, Ty + 19.75}, {Tx + m * 261.43, Ty + 49.8}, {Tx + m * 337.36, Ty + 89.35}, {Tx + m * 368.73, Ty + 70.34}, {Tx + m * 368.98, Ty + 72.55}, {Tx + m * 338.4, Ty + 89.89}, {Tx + m * 337.36, Ty + 89.35}}, {45, 193, 213});
    glFlush();
}
Scene currentScene;
void display()
